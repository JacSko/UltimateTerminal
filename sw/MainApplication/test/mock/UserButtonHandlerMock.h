...
UserButtonHandler::UserButtonHandler(GUIController& controller, uint8_t, const std::string&, Persistence::PersistenceHandler& persistence, std::function<bool(const std::string&)> writer)
